namespace ClassBasics.Classes
{
    ...
    public class Person
    {
        ...
        */
        ...
        //Typically, this is for private field in order to enforce encapsulation
        //If the field were to be public, then someone could just directly update the field or get the field without going trhough your getters or setters

        //The "this" keyword is used to refer to the object that has been created
        //this is referring to the field name in the class.  The one without the this is the one being passed into the function
        //so LastName is what you are sending to the function and this.LastName is the actual data stored in the instance of the class.
